...
public class User {
	...
	/**
	 * Returns whether or not the user represented by this object is an halfop
	 * (+h). If the User object has been obtained from a list of users in a
	 * channel, then this will reflect the user's operator status in that
	 * channel.
	 * 
	 * @return true if the user is an halfop in the channel
	 */
	...
	/**
	 * Returns whether or not the user represented by this object is the owner
	 * of the channel. If the User object has been obtained from a list of users
	 * in a channel, then this will reflect the user's owner status in that
	 * channel.
	 * 
	...
	/**
	 * Returns whether or not the user represented by this object is a channel
	 * administrator. If the User object has been obtained from a list of users
	 * in a channel, then this will reflect the user's operator status in that
	 * channel.
	 * 
	 * @return true if the user is an chanadmin in the channel.
	 */
	...
	/**
	 * Returns wheter or not the user represented by this object a channelstatus
	 * greater than or equal to being voiced.
	 * 
	 * @return true if the user has voice or above.
	 */
	public final boolean isVoicePlus() {
		return (this.isOp() || this.isHalfOp() || this.isChannelOwner()
				|| this.isChannelAdmin() || this.hasVoice());
	}

	/**
	 * Returns wheter or not the user represented by this object a channelstatus
	 * greater than or equal to being a halfop.
	 * 
	 * @return true if the user has halfop or above.
	 */
	public final boolean isHalfOpPlus() {
		return (this.isOp() || this.isHalfOp() || this.isChannelOwner() || this
				.isChannelAdmin());
	}

	/**
	 * Returns wheter or not the user represented by this object a channelstatus
	 * greater than or equal to being an operator.
	 * 
	 * @return true if the user has ops or above.
	 */
	public final boolean isOpPlus() {
		return (this.isOp() || this.isChannelOwner() || this.isChannelAdmin());
	}
